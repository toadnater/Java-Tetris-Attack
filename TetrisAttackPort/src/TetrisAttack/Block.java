...
public class Block {
	...
	public int grid_x;
	public int grid_y;
	public int graphic_x;
	public int graphic_y;
	...
	public Block(char c, Game depGame) {
		this();
		...
		// - Add our graphic to the image list
		depGame.screenHandle.addGraphic(associatedGraphic);
	}
	...
	public void setGraphicLocation(double x, double y) {
		...
		// System.out.println(associatedGraphic.getName() + "1: [" + graphic_x + "][" +
		// graphic_y + "]");
		// System.out.println(associatedGraphic.getName() + "2: [" +
		// associatedGraphic.getX() + "][" + associatedGraphic.getY() + "]");
	}
	...
	public void setGarbage(boolean set) {
		garbage = set;
	}
	...
	public void setFallRequest(boolean set) {
		fallRequest = set;
	}
	...
	public void setVisible(boolean set) {
		associatedGraphic.setVisible(set);
	}

	public void setComboOrigin(Block set) {
		comboOrigin = set;
	}
	...
	public boolean isFallRequested() {
		return fallRequest;
	}

	public boolean isEmptyBlock() {
		return colour.equals("emptyBlock");
	}

	public Block getComboOrigin() {
		return comboOrigin;
	}
